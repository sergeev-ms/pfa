...
class EquipmentSystem(
    ...
    constructor(referenceCode: String, accountId: String, customer: String, customerOrder: Int, rentalOrSale: String, systemNumber: Long) :
            this(referenceCode, accountId, customer, customerOrder, rentalOrSale, systemNumber, mutableListOf())
