...
@Role(name = FinancialManagerRole.NAME)
class FinancialManagerRole : AnnotatedRoleDefinition() {
    companion object {
        const val NAME = "financial-manager"
    }
    ...
    @ScreenAccess(screenIds = ["application-pfa", "pfa_Account.browse", "references-group", "pfa_DimCustomers.browse",
        ...
        "pfa_Activity.browse", "pfa_ActivityPivot.edit", "pfa_PriceList.browse", "pfa_PriceListPivot.edit",
        "pfa_MarketData.browse", "pfa_MarketData.edit",
        ...
        "pfa_EquipmentUtilizationValueType.browse", "pfa_DirectSale.edit", "country_Country.browse",
        "country_Country.edit", "reports"])
    ...
    @EntityAccessContainer(
        ...
        EntityAccess(entityClass = PriceList::class, operations = [EntityOp.READ, EntityOp.CREATE, EntityOp.UPDATE]),
        EntityAccess(entityClass = PriceListDetail::class,
            operations = [EntityOp.READ, EntityOp.CREATE, EntityOp.UPDATE]
        ),
        EntityAccess(entityClass = Activity::class, operations = [EntityOp.READ, EntityOp.CREATE, EntityOp.UPDATE]),
        EntityAccess(entityClass = ActivityDetail::class,
            operations = [EntityOp.READ, EntityOp.UPDATE, EntityOp.CREATE]
        ),
        EntityAccess(entityClass = KeyValueEntity::class,
        ...
        EntityAccess(entityClass = CountrySetting::class,
            operations = [EntityOp.READ, EntityOp.CREATE, EntityOp.UPDATE]
        ),
        EntityAccess(entityClass = CountrySettingAnalyticDetail::class,
            operations = [EntityOp.CREATE, EntityOp.READ, EntityOp.UPDATE, EntityOp.DELETE]
        ),
        EntityAccess(entityClass = CountrySettingEquipmentType::class,
            operations = [EntityOp.CREATE, EntityOp.READ, EntityOp.UPDATE, EntityOp.DELETE]
        ),
        EntityAccess(entityClass = CountrySettingRevenueType::class,
            operations = [EntityOp.UPDATE, EntityOp.READ, EntityOp.CREATE, EntityOp.DELETE]
        ),
        EntityAccess(entityClass = CountrySettingUtilizationValueType::class,
            operations = [EntityOp.CREATE, EntityOp.READ, EntityOp.UPDATE, EntityOp.DELETE]
        ),
        EntityAccess(entityClass = EquipmentUtilization::class,
            operations = [EntityOp.CREATE, EntityOp.READ, EntityOp.UPDATE]
        ),
        EntityAccess(entityClass = EquipmentUtilizationDetailValue::class,
            operations = [EntityOp.CREATE, EntityOp.READ, EntityOp.UPDATE]
        ),
        EntityAccess(entityClass = EquipmentUtilizationValueType::class,
            operations = [EntityOp.CREATE, EntityOp.READ, EntityOp.UPDATE]
        ),
    ...
    @EntityAttributeAccessContainer(
        ...
        EntityAttributeAccess(entityClass = CountrySetting::class, modify = ["*"]),
        EntityAttributeAccess(entityClass = CountrySettingAnalyticDetail::class, modify = ["*"]),
        EntityAttributeAccess(entityClass = CountrySettingEquipmentType::class, modify = ["*"]),
        EntityAttributeAccess(entityClass = CountrySettingRevenueType::class, modify = ["*"]),
        EntityAttributeAccess(entityClass = CountrySettingUtilizationValueType::class, modify = ["*"]),
        ...
        EntityAttributeAccess(entityClass = EquipmentUtilizationValueType::class, modify = ["*"]),
        ...
        EntityAttributeAccess(entityClass = PriceList::class, modify = ["*"]),
        EntityAttributeAccess(entityClass = PriceListDetail::class, modify = ["*"]),
        ...
        EntityAttributeAccess(entityClass = MeasurementUnit::class, view = ["*"]),
        EntityAttributeAccess(entityClass = MeasurementUnitSet::class, view = ["*"]),
