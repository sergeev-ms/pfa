...
@Role(name = CommercialDirectorRole.NAME, description = CommercialDirectorRole.DESCRIPTION)
class CommercialDirectorRole : AnnotatedRoleDefinition() {
    companion object {
        const val NAME = "commercial-director "
        const val DESCRIPTION = "Creates Price lists for all Accounts, etc."
    }
    ...
    @ScreenAccess(screenIds = ["application-pfa", "pfa_Account.browse", "references-group", "pfa_DimCustomers.browse",
        ...
        "pfa_ActivityPivot.edit", "pfa_PriceList.browse","pfa_PriceListPivot.edit", "pfa_MarketData.browse",
        "pfa_MarketData.edit",
    ...
    @EntityAccessContainer(
        ...
        EntityAccess(entityClass = PriceList::class, operations = [EntityOp.CREATE, EntityOp.UPDATE, EntityOp.READ]),
        EntityAccess(entityClass = PriceListDetail::class, operations = [EntityOp.CREATE, EntityOp.UPDATE, EntityOp.READ, EntityOp.DELETE]),
    ...
    @EntityAttributeAccessContainer(
        ...
        EntityAttributeAccess(entityClass = PriceList::class, modify = ["*"], view = ["recordType"]),
    ...
    @ScreenComponentAccess(screenId = "pfa_Account.edit", view = ["attachmentFragment.filesMultiUpload"])
