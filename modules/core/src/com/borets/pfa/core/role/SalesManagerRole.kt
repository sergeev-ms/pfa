...
class SalesManagerRole : AnnotatedRoleDefinition() {
    ...
    @ScreenAccess(screenIds = ["application-pfa", "pfa_Account.browse", "references-group", "pfa_DimCustomers.browse",
        "pfa_SystemStd.browse", "pfa_Employee.edit", "pfa_Employee.browse", "pfa_Account.edit", "pfa_ApplicationDataFragment",
        "pfa_Activity.browse",
    ...
    @EntityAccessContainer(
        ...
        EntityAccess(entityClass = Supplementary::class, operations = [EntityOp.READ, EntityOp.UPDATE, EntityOp.CREATE]),
        EntityAccess(entityClass = SupplementaryDetail::class, operations = [EntityOp.READ, EntityOp.UPDATE, EntityOp.CREATE]),
