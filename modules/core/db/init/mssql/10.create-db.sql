...
-- begin PFA_COUNTRY_SETTING_REVENUE_TYPE_ANALYTIC_SET_LINK
...
-- begin PFA_COUNTRY_SETTING_UTILIZATION_VALUE_TYPE_ANALYTIC_SET_LINK
create table PFA_COUNTRY_SETTING_UTILIZATION_VALUE_TYPE_ANALYTIC_SET_LINK (
    COUNTRY_SETTING_UTILIZATION_VALUE_TYPE_ID uniqueidentifier,
    ANALYTIC_SET_ID uniqueidentifier,
