...
--        VALUE_TYPE_ID,
               ...
               EQ_UTIL.VALUE_
        FROM report_internal_ApplicationData(DEFAULT, DEFAULT, DEFAULT, DEFAULT) APP_DATA
                 JOIN report_internal_EquipmentUtilization(DEFAULT, DEFAULT, DEFAULT, DEFAULT) EQ_UTIL
